...
/**
 * Form Request para validar la actualización de un canal
 */
class UpdateChannelRequest extends FormRequest
{
    ...
    {
        // Verifica que el usuario autenticado sea el propietario del canal
        $channel = $this->route('channel');

        return auth()->check() && $channel && auth()->id() === $channel->user_id;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'url' => [
                ...
                Rule::unique('channels', 'url')->ignore($channel->id),
